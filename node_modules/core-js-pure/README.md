...
**It's a version without global namespace pollution (the third example), for more info see [`care-js` documentation](https://github.com/zloirock/core-js/blob/master/README.md)**.
